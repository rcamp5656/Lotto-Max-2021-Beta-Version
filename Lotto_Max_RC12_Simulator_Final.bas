...
Rem *** Lotto Max Simulator Version 2021 RC14 Working Version With Automatic Draw Date Update
Rem *** Fully 99.999 % working copy Most up to date.
Rem *** Written by: Russ Campbell
Rem
Rem *** Last Update : June 30 2021  12:01 AM
Rem
...
Locate 6, 9
Print " Lotto Max 2020 RC14 Version Lotto Max Simulator Final Vers  "
Locate 7, 9
...
Locate 14, 8
GoSub getdate
Print Using "  Winning Numbers Database Updated On : \     \   \  \  ##  #### "; d5$; month$(month); day; year

If crs$ = "Y" Then Color 10, 5
Locate 5, 8
Print "        Lotto Max Simulator RC14 Version 2021  Main Menu          "
...
If crs$ = "Y" Then Color 10, 5
Locate 3, 7
Print "     Lotto Max Simulator RC14 Version 2021 Barchart Menu            "
Locate 13, 7
...
For i = 1 To 50
    ...
    If crs$ = "Y" Then Color 10, 5
    Locate 4, 11
    Print "Lotto Max Simulator RC14 Version 2021   Search & Print Menu"
    If crs$ = "Y" Then Color 4, 7
    For i = 6 To 10
        Locate i, 17
        Print "["
...
GoSub getdate
Print
Print "Lotto Max Package Version 2021 RC14 Winning Numbers Entry"
Print "--------------------------------------------------------"
Print
...
Print
Print "Winning Numbers Updated on "; d5$; " "; month$(month); day; year
Print "Last numbers entered : "; entrya; entryb; entryc; entryd; entrye; entryf; entryg; entryh
GoSub getdate
Print "Next Draw Date : "; d5$; " "; month3$; d5 + nextdate; virtualyear
Print

enternumbers:
Print
first:
Print "Enter 1st number for the draw of "; d5$; " "; month3$; " "; d5; virtualyear
...
second:
Print "Enter 2nd number for the draw of : "; d5$; " "; month3$; " "; d5; virtualyear
...
third:
Print "Enter 3rd number for the draw of : "; d5$; " "; month3$; " "; d5; virtualyear
...
fourth:
Print "Enter 4th number for the draw of :"; d5$; " "; month3$; " "; d5; virtualyear
...
fifth:
Print "Enter 5th number for the draw of "; d5$; " "; month3$; " "; d5; virtualyear
...
sixth:
Print "Enter 6th number for the draw of "; d5$; " "; month3$; " "; d5; virtualyear
...
seventh:
Print "Enter 7th number for the draw of "; d5$; ""; mont3$; " "; d5; virtualyear
...
eighth:
Print "Enter bonus number for the draw of "; d5$; " "; month3$; " "; d5; virtualyear
...
Print
Print "You Have Entered for the draw of : "; d5$; " "; month3$; " "; d5; virtualyear
...
If answer$ = "Q" Or answer$ = "q" Then Close #: GoTo main
If answer$ = "Y" Then

    Print #1, Using "## ## ####  ## ## ## ## ## ## ## ##"; mnth; d5; virtualyear; entrya; entryb; entryc; entryd; entrye; entryf; entryg; entryh
End If
Print
...
Locate 4, 18
Print " Lotto Max Version 2021 RC14  Print Menu  "
If crs$ = "Y" Then Color 3, 8
Locate 3, 17
Print Chr$(201)
For i = 18 To 57
...
Cls
Print
Print "Lotto Max 2020 RC14 Simulation Program With Real Time Game Play Rules."
Print "---------------------------------------------------------------------"
Print
...
Cls
Print
Print "Basic Rules and object of this Lotto Max 2020 RC14 Lottery Simulator"
Print "-------------------------------------------------------------------"
Print
...
Print
Print
Print "About This Lotto Max RC14 Simulator and all of the other"
...
Print "(6) Welcome to the Lotto Max 2020 RC14 Simulator'"
...
For l = 1 To total
    ...
    If today$ = "Friday" Then d5$ = TODAY3$: d5 = d1 + nextday
    If today$ = "Tuesday" Then d5$ = TODAY2$: d5 = d1 + nextday
