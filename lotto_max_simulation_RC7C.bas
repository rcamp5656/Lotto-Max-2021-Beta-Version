...
GOSUB getdate
PRINT USING "  Winning Numbers Database Updated On : \ \  \ \  ##-#### "; GetDay$(m, (D1 + LASTDAY), y); month$(m); (D1 + LASTDAY); y
...
IF answer$ = "Y" THEN
    ...
    PRINT #1, USING "## ## ####  ## ## ## ## ## ## ## ##"; nextdraw; D1; y; entrya; entryb; entryc; entryd; entrye; entryf; entryg; entryh
