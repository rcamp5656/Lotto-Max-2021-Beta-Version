...
seventh:
PRINT "Enter 7th number for the draw of "
...
IF answer$ = "Y" THEN
    ...
    PRINT #1, USING "## ## ####  ## ## ## ## ## ## ## ##"; Mnth; dd1; VirtualYear; entrya; entryb; entryc; entryd; entrye; entryf; entryg; entryh
...
FOR j = 1 TO 50
    ...
    IF thn2 < (now2 - 20) THEN
        ...
        LPRINT USING "Number ## is a good bet, it was due by : ## ## ####"; j; month3; day3; year3
    END IF
    k = 0
    PRINT #1, ""
NEXT j
