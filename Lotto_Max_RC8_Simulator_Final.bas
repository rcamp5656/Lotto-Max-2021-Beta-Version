...
Rem *** Lotto Max Simulator Version 2021 RC12 Working Version With Automatic Draw Date Update
Rem *** Fully 99.999 % working copy Most up to date.
Rem *** Written by: Russ Campbell
Rem
Rem *** Last Update : May 12 2021  12:01 AM
Rem
...
Locate 6, 9
Print " Lotto Max 2020 RC10 Version Lotto Max Simulator Final Vers  "
Locate 7, 9
...
Locate 11, 14
Print "Release Date  : May   2021  -  12:01 AM          "
Locate 12, 14
Print "Registered To :                                    "
Locate 12, 30
Print reg$
...
If crs$ = "Y" Then Color 10, 5
Locate 5, 8
Print "        Lotto Max Simulator RC8 Version 2021  Main Menu           "
...
For i = 1 To 50
    ...
    If crs$ = "Y" Then Color 10, 5
    Locate 4, 11
    Print "Lotto Max Simulator RC8 Version 2021   Search & Print Menu"
    If crs$ = "Y" Then Color 4, 7
    For i = 6 To 10
        Locate i, 17
        Print "["
...
beginning:
GoSub getdate
month2 = Val(Mid$(realdate$, 6, 2))
day2 = Val(Mid$(realdate$, 9, 2))
year2 = Val(Mid$(realdate$, 1, 4))
month3 = Val(Mid$(realdate2$, 6, 2))
day3 = Val(Mid$(realdate2$, 9, 2))
year3 = Val(Mid$(realdate2$, 1, 4))
Cls
Print
Print "Lotto Max Package Version 2021 RC8 Winning Numbers Entry"
Print "--------------------------------------------------------"
Print
...
Print
Print "Winning Numbers Updated on "; today$; " "; month$(month2); day2; year2
Print "Last numbers entered : "; entrya; entryb; entryc; entryd; entrye; entryf; entryg; entryh
GoSub getdate
Print "Next Draw Date "; today$; " "; month$(month3); " "; day3; year3
Print

enternumbers:
Print
first:
Print "Enter 1st number for the draw of "; month$(month3); " "; day3; year3
...
second:
Print "Enter 2nd number for the draw of : "; month$(month3); " "; day3; year3
...
third:
Print "Enter 3rd number for the draw of : "; month$(month3); " "; day3; year3
...
fourth:
Print "Enter 4th number for the draw of :"; month$(month3); " "; day3; year3
...
fifth:
Print "Enter 5th number for the draw of "; month$(month3); " "; day3; year3
...
sixth:
Print "Enter 6th number for the draw of "; month$(month3); " "; day3; year3
...
seventh:
Print "Enter 7th number for the draw of "; month$(month3); " "; day3; year3
...
eighth:
Print "Enter bonus number for the draw of "; month$(month3); " "; day3; year3
...
Print
Print "You Have Entered for the draw of : "; month$(month3); " "; day3; year3
...
If answer$ = "Y" Then
    ...
    Print #1, Using "## ## ####  ## ## ## ## ## ## ## ##"; month3; day3; year3; entrya; entryb; entryc; entryd; entrye; entryf; entryg; entryh
...
If answer$ = "" Or answer$ = "Y" Or answer$ = "y" Then
    count = 1: Close #1: GoSub buildchart: GoSub convert: GoTo enterwinningnumbers
Else
    Close #1
    GoSub buildchart
    GoSub convert
