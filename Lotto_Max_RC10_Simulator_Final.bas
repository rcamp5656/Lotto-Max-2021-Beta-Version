...
Rem *** Lotto Max Simulator Version 2021 RC15 Working Version With Automatic Draw Date Update
Rem *** Fully 99.999 % working copy Most up to date.
Rem *** Written by: Russ Campbell
Rem
Rem *** Last Update : May 7 2021 3:00 PM
Rem
...
Locate 6, 9
Print "Lotto Max 2021 RC15 Version Lotto Max Simulator Final Vers  "
Locate 7, 9
...
Locate 11, 14
Print "Release Date  : May  7  2021  -  3:00 PM           "
Locate 12, 14
Print "Registered To :                                    "
Locate 12, 30
Print reg$
...
Cls
Print
Print "  Welcome to the Lotto Max 2021 Simulator. This program has been written to"
Print "  show you that if you gamble a whole lot of money recklessly, you will loose"
Print "  BIG TIME. But for those of you who still think that you can spend a lot of "
Print "  money on ANY LOTTERY , you wil win, it will allow you to do just that but"
Print "  not by spending real money. You keep track of the lotteries just as if you"
Print "  were playing a real lottery. The program keeps track of every dollar spent"
Print "  and every dollar won, then keeps a running total of what you are winning or"
Print "  loosing. Although you could use this program to play for real, I strongly "
Print "  advise against doing so, THIS PROGRAM IS ONLY FOR ENTERTAINMENT PURPOSES !"
Print
Print "  Here is where I give a disclaimer: This is just a game for Entertainment"
Print "  purposes. I understand that I am not using any real money in this game,"
Print "  nor will I win any real money in this game."
Print "  Any losses incurred from this program are my own resposibility."
Print "  Not the author of this program or anyone involved in it in any way"
Print "  shape or form."
Print
Print "  Even though it is a game , it has been written for the problem gambler,"
Print "  I hope I reach someone who needs it."
Print
...
Locate 14, 8
GoSub getdate
Print Using "  Winning Numbers Database Updated On : \  \ ##  ####"; month$(month); day; year

If crs$ = "Y" Then Color 10, 5
Locate 5, 8
Print "        Lotto Max Simulator RC15 Version 2021  Main Menu          "
...
If crs$ = "Y" Then Color 10, 5
Locate 3, 7
Print "     Lotto Max Simulator RC15 Version 2021 Barchart Menu           "
Locate 13, 7
...
For i = 1 To 50
    ...
    If crs$ = "Y" Then Color 10, 5
    Locate 4, 11
    Print "Lotto Max Simulator RC15 Version 2021  Search & Print Menu"
    If crs$ = "Y" Then Color 4, 7
    For i = 6 To 10
        Locate i, 17
        Print "["
...
Color 1, 7
Print
Print "  Lotto Max Package Version 2021 RC15 Winning Numbers Entry"
Print "  ---------------------------------------------------------"
Print
...
Print "  Winning Numbers Updated on "; month$(month); " "; day; " "; year
Print "  Last numbers entered : "; entrya; entryb; entryc; entryd; entrye; entryf; entryg; entryh
Print "  Next Draw Date "; today$; " "; month$(Mnth); " "; D1; VirtualYear
Print
Print "Press any key to continue...."
Do While InKey$ = ""
Loop
...
Locate 4, 18
Print " Lotto Max Version 2021 RC15  Print Menu  "
If crs$ = "Y" Then Color 3, 8
Locate 3, 17
Print Chr$(201)
For i = 18 To 57
...
Cls
Print
Print "  Lotto Max 2021 RC15 Simulation Program With Real Time Game Play Rules."
Print "  ---------------------------------------------------------------------"
Print
...
Print
Print
Print "  About This Lotto Max RC15 Simulator and all of the other"
...
Print "  (6) Welcome to the Lotto Max 2021 RC15 Simulator"
