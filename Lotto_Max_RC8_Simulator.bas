...
newbalance = oldbalanace - moneyspent
INPUT oldbalance
PRINT
CLOSE #1
...
newbalance = oldbalance + totalbalance + winningstotal - moneytotal
...
PRINT USING pt$; newbalance; money; winningstotal; newbalance
PRINT "|--------------------------------------------------------------------------|"
PRINT
PRINT
PRINT "Press any key to continue..."
...
CLS
PRINT
PRINT "Lotto Max 2020 RC7 Simulation Program With Real Time Game Play Rules."
PRINT "---------------------------------------------------------------------"
PRINT
